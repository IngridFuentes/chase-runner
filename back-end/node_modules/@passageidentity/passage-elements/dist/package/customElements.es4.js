...
import { d as defineComponent, f as ref, ab as watchEffect, ac as onUnmounted, _ as _export_sfc, o as openBlock, b as createBlock, e as withCtx, c as createElementBlock, a as createBaseVNode, q as normalizeClass, t as toDisplayString, r as renderSlot, p as withModifiers, z as createCommentVNode, a9 as withKeys, T as Transition, h as useLocale, i as usePassage, j as computed, a7 as resolveComponent, n as createTextVNode, S as useAddDevice, M as E, u as unref, H as InlineSvg, I as Icons, ad as onUpdated, k as onMounted, g as watch, w as withDirectives, x as vModelText, ae as h, F as createVNode, X as Dropdown, L as Fragment, R as renderList, y as normalizeStyle, a6 as dayjs, a8 as le, a0 as onBeforeUpdate, a1 as useStoreLocale, a2 as useIntlTelInput, a3 as createPassageInstance, K as useDefaultCountryCode } from "./customElements.es.js";
...
const _hoisted_1$7 = /* @__PURE__ */ createBaseVNode("div", { class: "passage-modal-background" }, null, -1);
...
var Modal = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$1]]);
...
const _sfc_main$7 = defineComponent({
  ...
  setup(props, context) {
    ...
    const { revokeDevice, revokePending, errorMessage } = useRevokeDevice();
  ...
  return openBlock(), createBlock(_component_modal, {
    ...
    default: withCtx(() => {
      ...
      return [
        ...
        !_ctx.errorMessage ? (openBlock(), createElementBlock("div", _hoisted_1$6, [
          createTextVNode(toDisplayString(_ctx.t("confirm-remove-device")) + " ", 1),
          ((_a = _ctx.device) == null ? void 0 : _a.id) === _ctx.currentDeviceId ? (openBlock(), createElementBlock("b", _hoisted_2$6, toDisplayString(_ctx.t("remove-current-device-warning")), 1)) : createCommentVNode("", true),
...
var RevokeDevice = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render]]);
const _hoisted_1$5 = { class: "has-text-centered" };
const _hoisted_2$5 = {
  key: 1,
  class: "text is-danger has-text-centered"
};
const _hoisted_3$4 = { key: 2 };
const _hoisted_4$3 = { style: { "margin-bottom": "12px" } };
...
const _hoisted_8$2 = ["onClick", "disabled"];
const _hoisted_9$2 = {
  key: 4,
  class: "flex-row flex-center"
};
...
const _sfc_main$6 = defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    const supportsPlatform = computed(() => {
      var _a, _b;
      return (_b = (_a = props.browserFeatures) == null ? void 0 : _a.platform) != null ? _b : false;
    });
    const supportsCrossPlatform = computed(() => {
      var _a, _b;
      return (_b = (_a = props.browserFeatures) == null ? void 0 : _a.securityKey) != null ? _b : false;
    });
    ...
    function primaryAddDevice() {
      if (supportsPlatform.value === true) {
        onAddDevice(E.Platform);
      } else {
        onAddDevice(E.CrossPlatform);
      }
    }
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(Modal, {
        ...
        default: withCtx(() => [
          ...
          unref(errorMessage) ? (openBlock(), createElementBlock("div", _hoisted_2$5, toDisplayString(unref(errorMessage)), 1)) : createCommentVNode("", true),
          !unref(errorMessage) ? (openBlock(), createElementBlock("div", _hoisted_3$4, [
            createBaseVNode("div", _hoisted_4$3, toDisplayString(unref(t)("passkeys-are-a-simple")), 1),
            createBaseVNode("div", _hoisted_5$3, toDisplayString(unref(t)("passkey-register-options")), 1)
          ])) : createCommentVNode("", true),
          !unref(errorMessage) ? (openBlock(), createElementBlock("div", _hoisted_6$2, [
          ...
          createBaseVNode("div", _hoisted_11$1, [
            ...
            }, toDisplayString(unref(t)("cancel")), 9, _hoisted_12$1)
          ])
        ]),
        _: 1
      }, 8, ["title", "active"]);
...
const _hoisted_1$4 = { class: "label input-box-title" };
const _hoisted_2$4 = { class: "message is-danger" };
const _hoisted_3$3 = {
  key: 1,
  class: "text is-danger"
};
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(Modal, {
        ...
        default: withCtx(() => [
          ...
          createBaseVNode("div", _hoisted_1$4, toDisplayString(_ctx.newDevice ? unref(t)("device-name") : unref(t)("new-device-name")), 1),
          ...
          createBaseVNode("div", _hoisted_2$4, toDisplayString(validationError.value), 1),
          unref(errorMessage) ? (openBlock(), createElementBlock("div", _hoisted_3$3, toDisplayString(unref(errorMessage)), 1)) : createCommentVNode("", true)
        ]),
        _: 1
...
const _hoisted_2$2 = ["onMousedown", "data-test"];
...
const _hoisted_8 = { class: "expanded-content" };
const _hoisted_9 = { class: "expanded-label" };
const _hoisted_10 = {
  key: 1,
          ...
          createBaseVNode("tbody", null, [
            ...
            page.value ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(page.value, (item, index) => {
                    ...
                    createBaseVNode("div", _hoisted_8, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.columns.slice(1), (column, index2) => {
                        return openBlock(), createElementBlock("div", {
                          ...
                          createBaseVNode("div", _hoisted_9, toDisplayString(_ctx.headers[index2 + 1]), 1),
              ...
              createBaseVNode("td", {
                ...
                createBaseVNode("div", _hoisted_12, toDisplayString(unref(t)("no-devices-found")), 1),
...
const _sfc_main = defineComponent({
  ...
  setup(__props) {
    ...
    passage.createCredentialAvailable().then((features) => browserFeatures.value = features);
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        refreshing.value ? (openBlock(), createBlock(_sfc_main$4, {
          key: 0,
        ...
        createVNode(_sfc_main$6, {
          ...
          "browser-features": browserFeatures.value
        }, null, 8, ["active", "browser-features"]),
        selectedDevice.value ? (openBlock(), createBlock(RevokeDevice, {
          ...
          onDialogClose: actionFinished
        }, null, 8, ["active", "device", "currentDeviceId"])) : createCommentVNode("", true),
...
function useCurrentUser(appInfo) {
  ...
  function transformMetadata() {
    ...
    appInfo.user_metadata_schema.forEach((schema) => {
      ...
      if (schema.type === le.DATE && metadataValue) {
...
export { _sfc_main$4 as _, _sfc_main as a, useProfileElementSetup as b, useCurrentUser as u };
//# 
