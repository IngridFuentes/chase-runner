...
import { d as defineComponent, h as useLocale, f as ref, j as computed, k as onMounted, m as onBeforeUnmount, _ as _export_sfc, o as openBlock, c as createElementBlock, a as createBaseVNode, t as toDisplayString, r as renderSlot, p as withModifiers, z as createCommentVNode, q as normalizeClass, a9 as withKeys, g as watch, a7 as resolveComponent, b as createBlock, F as createVNode, e as withCtx, w as withDirectives, x as vModelText, L as Fragment, K as useDefaultCountryCode, l as ce, aa as ue, u as unref, P, Y as useAppInfo, v as vShow, s as safelyRegisterElement } from "../customElements.es.js";
import { u as useUpdateUser, i as intlTelInput, a as isEmail, U as UserMetadata, L as LayoutType } from "../customElements.es3.js";
import { u as useCurrentUser, _ as _sfc_main$8, a as _sfc_main$9, b as useProfileElementSetup } from "../customElements.es4.js";
...
var EditableControl = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$4]]);
...
var PhoneNumber = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$3]]);
...
var Email = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$2]]);
const _sfc_main$4 = defineComponent({
  ...
  setup(props) {
    ...
    const showEmail = computed(() => {
      return props.appInfo.allowed_identifier !== ce.phone;
    });
    const showPhone = computed(() => {
      return props.appInfo.allowed_identifier !== ce.email;
    });
    const emailRequired = computed(() => {
      return props.appInfo.required_identifier === ue.Email || props.appInfo.required_identifier === ue.Both;
    });
    const phoneRequired = computed(() => {
      return props.appInfo.required_identifier === ue.Phone || props.appInfo.required_identifier === ue.Both;
    });
    return {
      message,
      globalMessage,
...
var UserInfo = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$1]]);
...
var MetadataSection = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render]]);
const _hoisted_1$1 = {
  key: 1,
...
const _sfc_main$2 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        unref(loading) ? (openBlock(), createBlock(_sfc_main$8, {
          key: 0,
          active: unref(loading)
        }, null, 8, ["active"])) : unref(error) && unref(error).statusCode !== unref(P).PSGLoginRequired ? (openBlock(), createElementBlock("div", _hoisted_1$1, " Unable to get information about current user: " + toDisplayString(unref(error).statusText), 1)) : createCommentVNode("", true),
...
const _sfc_main$1 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        unref(appInfoLoading) || !initialized.value ? (openBlock(), createBlock(_sfc_main$8, {
          key: 0,
        ...
        }, null, 8, ["appInfo", "webauthnAllowed"])) : createCommentVNode("", true)
      ], 64);
    };
  }
});
