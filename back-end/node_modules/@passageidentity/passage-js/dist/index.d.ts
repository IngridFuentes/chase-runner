...
declare class Passage {
    ...
    /**
     * @deprecated Perform a magic link login or a webauthn login instead.
    ...
    /**
     * @deprecated Use Passage.getCurrentUser().addDevice() instead
...
export { AllowedFallbackAuth, AuthenticatorAttachment, BrowserInfo, CaptureEventBody, CreateUserPayload, ICaptureEventProps, IElementCustomization, ISentryConfig, Identifier, Metadata, Passage, PassageAppInfo, PassageDevice, PassageEditDeviceRequest, PassageError, PassageErrorCode, PassageMagicLinkRequest, PassageSentryProject, PassageTokenStore, PassageUser, PassageUserInfo, PassageUserStatus, PasskeyCreationOptions, ReadOnlyTokenStore, RequiredIdentifier, Session, TokenStore, User, UserMetadataLayout, UserMetadataSchema, UserMetadataType, WebAuthnType, WebSafeFonts, authResult, captureEvent, cleanSentryConfig, isFullTokenStore };
