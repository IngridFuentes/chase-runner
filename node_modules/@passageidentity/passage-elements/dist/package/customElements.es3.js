...
import { a8 as commonjsGlobal, d as defineComponent, f as ref, j as computed, _ as _export_sfc, o as openBlock, c as createElementBlock, w as withDirectives, a9 as vModelCheckbox, a as createBaseVNode, n as normalizeClass, q as withModifiers, t as toDisplayString, h as useLocale, x as vModelText, aa as dayjs, ab as resolveComponent, E as createVNode, k as onMounted, g as watch, v as vShow, N as useDefaultCountryCode, L as Fragment, K as renderList, b as createBlock, a2 as resolveDynamicComponent, ac as he, i as usePassage, I as Icons } from "./customElements.es.js";
...
function transformMetadata(metadata, schema, defaultBooleans = false) {
  ...
  schema.forEach((schema2) => {
    ...
    if (schema2.type === he.DATE && metadataValue) {
      transformedMetadata[schema2.field_name] = dayjs(metadataValue).format("YYYY-MM-DD");
    }
    if (defaultBooleans && schema2.type === he.BOOLEAN && metadataValue === void 0) {
